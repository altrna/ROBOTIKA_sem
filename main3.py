...
class Box:
    def __init__(self, SE3, box_id, cubes_id):
        self.SE3 = SE3
        self.id = box_id
        self.cubes_id = cubes_id
...
def aruco_init(cmd, camera, camera_matrix, distortion_matrix, base2cam):
    move_to_pos(cmd, [0,0,0,0,0,0])
    arucos = get_arucos_pose(camera, camera_matrix, distortion_matrix, base2cam)
